...
#interrupt: If you're unsure how to play with the codesheet, go straight to 3.7 on line 98 on this File to follow the instructions
#1. .vscode
#2. NCBIQuery.sh
#3. NeedlemanWunsch2.py

#Chapter 1.
#this order is here, because i use vscodium
#it contains a settings file to set the right environment.
